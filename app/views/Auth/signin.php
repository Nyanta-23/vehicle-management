                ...
                <div id="auth-left">
                    ...
                    <form action="<?= BASE_URL ?>/Auth/signin" method="post">
                        ...
                        <div class="form-check form-check-lg d-flex align-items-end">
                            <input class="form-check-input me-2" type="checkbox" name="rememmber" id="flexCheckDefault" />
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class="text-gray-600">Don't have an account? <a href="<?= BASE_URL; ?>/Auth/signup" class="font-bold">Sign up</a>.</p>
                    </div>
                </div>
            </div>
